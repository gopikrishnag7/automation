...
{
    public class Dispute_Resolution_and_Mutual_Agreement
    {
        public static void Dispute_Resolution_SaveNContinue()
        {
            ...
            //Dispute Resolution and Mutual Agreement to Binding Arbitration pane
            browind.SearchProperties[UITestControl.PropertyNames.Name] = "Dispute Resolution and Mutual Agreement to Binding Arbitration";

            //check checkbox
            HtmlCheckBox chkBox = new HtmlCheckBox(browind);
            chkBox.SearchProperties[HtmlCheckBox.PropertyNames.Id] = "arb_agree_ack";
